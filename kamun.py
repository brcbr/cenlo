            ...
            with PRINT_LOCK:
                ...
                if found_info['found'] or found_info['found_count'] > 0:
                    if not is_special_address_found:
                        ...
                        # Special address ditemukan, hanya tampilkan pesan minimal
                        print(f"\n{gpu_prefix} ✅ Special address found in batch {batch_id}. Status updated in database.")
                    ...
                    with STOP_SEARCH_FLAG_LOCK:
                        ...
                        if not is_special_address_found:
                            ...
                            print(f"\n[SYSTEM] 🚨 GLOBAL STOP_SEARCH_FLAG diaktifkan (special address found).")
                else:
